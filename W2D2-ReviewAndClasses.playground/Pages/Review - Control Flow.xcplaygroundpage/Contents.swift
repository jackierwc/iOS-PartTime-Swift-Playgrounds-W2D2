...
if kph > 0 {print("We're moving \(kph) km/h")}
else {print("We're standing still")}
...
if kph > 30 {print("Whoa slow down buddy, \(kph) km/h is too fast for this school zone!")}
else if kph > 0 {print("We're moving \(kph) km/h")}
else {print("We're standing still")}
